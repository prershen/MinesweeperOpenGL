...
void front(void)
{
    ...
    glColor3f(0, 0, 1);
    drawstring(30.0, 90.0, 0.0, "RV COLLEGE OF ENGINEERING");
    glColor3f(0.7, 0, 1);
    drawstring(21, 82, 0.0, "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
    glColor3f(1, 0.5, 0);
    drawstring(40, 70, 0.0, "MINI PROJECT");
    glColor3f(1, 0, 0);
    drawstring(40, 60, 0.0, "MINESWEEPER");
    glColor3f(1, 0.5, 0);
    drawstring(20, 50, 0.0, "By:");
    glColor3f(1, 0.1, 1);
    drawstring(10, 40, 0.0, "Pratheeksha P (1RV17CS112)");

    drawstring(10, 34, 0.0, "Prerana Shenoy SP (1RV17CS114)");
    glColor3f(1, 0.5, 0);
    drawstring(68, 50, 0.0, "Mentor:");
    glColor3f(0.5, 0.2, 0.2);
    drawstring(63, 40, 0.0, "Dr. Hemavathy R");
